...
module.exports = function howto_buildORM(sails) {
  return function buildORM(modelDefs, cb) {
    ...
    // App defaults from `sails.config.models`, minus any models supplied externally
    var appDefaults = _.reject(sails.config.models, function(model, identity) {
      return _.keys(sails._external.models).indexOf(identity) !== -1;
    });
    ...
    waterline.initialize({
      ...
      // Merge any external models back in
      _.extend(sails.models, sails._external.models);
